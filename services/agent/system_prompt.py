...
- Protège l'explicite: une règle "ne déplace jamais / sans me demander / verrouille" prime sur toute autorisation de réorganiser; en conflit, garde l'élément protégé et demande le compromis. Sinon résous les conflits toi-même (ex: un quart de nuit qui chevauche le sommeil → saute l'occurrence de sommeil concernée), ne renvoie pas le problème à l'utilisateur.
